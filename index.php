...
<body class="bg-gradient-login" style="background-image: url('img/logo/logo.png');">
    <!-- Login Content -->
    <div class="container-login" style="margin: auto; max-width: fit-content;">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    <h5 align="center" class="text-danger">eAttendee - STUDENT ATTENDANCE SYSTEM</h5>
